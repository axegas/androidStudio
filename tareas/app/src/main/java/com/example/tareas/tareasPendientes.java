...
public class tareasPendientes extends AppCompatActivity implements View.OnClickListener {
    ...
    public void iniciaBotones(){
        ...
        pendientes.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
        pendientes.setTextColor(getResources().getColor(R.color.white));
        todas.setTextColor(getResources().getColor(R.color.black));
        acabadas.setTextColor(getResources().getColor(R.color.black));
