...
import static com.example.trabajoed.R.color.colorAccent;

public class tareasTodas extends AppCompatActivity {
    ...
    public void iniciaBotones(){
        ...
        todas.setBackgroundColor(0xFF0000DD);
        pendientes.setTextColor(0xFF000000);
